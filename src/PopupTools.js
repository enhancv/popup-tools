 ...
 * @return {Object}
 */
function popupExecute(execute, url, name, options, callback, fromPopup) {
 ...
 * @return {Object}
 */
function popup(url, name, options, callback, fromPopup) {
  return popupExecute(window.open, url, name, options, callback, fromPopup);
}
